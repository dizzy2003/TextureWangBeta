...
//        Debug.Log(" mousePos "+mousePosition+ " dropInfo "+ dropInfo);
        if (dropInfo != null)
        {
    ...
    private static Vector2 GetFakeMousePosition( EditorWindow wnd, DockPosition position ) {
        ...
        var ret= GUIUtility.GUIToScreenPoint( mousePosition );
//        Debug.Log(" mouse pos "+mousePosition+" to screen point "+ret);
        return ret;
    }
}
#endif
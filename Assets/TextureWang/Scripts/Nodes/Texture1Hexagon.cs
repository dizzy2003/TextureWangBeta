...
{
    [Node (false, "Source/Hexagon")]
    public class Texture1Hexagon : CreateOp
    {
        public float m_OffsetX;
        public float m_OffsetY;

        public const string ID = "Hexagon";

...
namespace NodeEditorFramework 
{
	...
	{ // holds the state of a NodeCanvas inside a NodeEditor
        ...
        [NonSerialized] public bool didDragNode; // if we drag and release without moving then thats selecting this node 
        ...
        [NonSerialized]public bool dragSelection; // dragging selection box
